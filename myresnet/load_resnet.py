...
def run():
  ...
  resnet50 = torch.load('myresnet/resnet50.pt', map_location=device)
  ...
  def mscluster(data):
    ...
    plt.savefig('static/clustering/clustering.png')

    origin_image = Image.open('static/clustering/clustering.png')
    cropped_image = origin_image.crop((90,100,950,950))
    cropped_image.save('static/clustering/clustering.png')
